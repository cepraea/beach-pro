...
>
> ---
> **`REPOSITORY_CANONICAL_ID`** = `cepraea/beach-pro`
>
> **`BOOTSTRAP_SCRIPT_CANONICAL_PATH`** = `test/scripts/bootstrap/Bootstrap.py`
>
> **`BOOTSTRAP_README_CANONICAL_PATH`** = `test/scripts/bootstrap/README.md`
> ---
> Os dois paths acima são relativos exclusivamente à raiz do repositório `CEPRAEA/beach-pro`.
